...
import {
  ...
  DialogTitle,
  DialogTrigger,
} from '@/components/metronic/ui/dialog';
import { Input } from '@/components/metronic/ui/input';
import { ScrollArea } from '@/components/metronic/ui/scroll-area';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/metronic/ui/tabs';
import { DropdownMenu4 } from '@/components/metronic/layouts/layout-1/shared/dropdown-menu/dropdown-menu-4';
import {
  SearchDocs,
  SearchDocsItem,
  SearchEmpty,
