import { Mails, Settings, Plus, NotepadText, User, Clock, Shield, Building2, Users, LogOut, Download, ExternalLink, Zap, Target, Sun, Moon, Search } from "lucide-react";
...
import {
  ...
  AvatarIndicator,
  AvatarStatus,
} from '@/components/metronic/ui/avatar';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function HeaderToolbar() {
  ...
  return (
    <nav className="flex items-center gap-2.5">
      <InputWrapper className="w-full lg:w-65 hidden lg:inline-flex">
        <Search />
